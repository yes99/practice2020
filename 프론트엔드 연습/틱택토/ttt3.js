...
const tds = [];
let turn = 'X';
//콜백 함수 수행할때, 콜백함수를 콜 할대, 단순하게 하는게 아니라, 데이터를 담아서 같이 전송,   파라미터, 
//객체가 가질수 있는 상태? 특성? 이벤트... - > 공을 객체라고 한다면, 공이 누군가에 의해서 던져질수도 있고, 위에서 누를수도 잇고 등등
// 이벤트를 예로 들면 누군가에게 차엿다, 등등 


const marking = function(event) {
    //indexOf  문자내에서 특정한 문자열의 index 값을 리턴한다
