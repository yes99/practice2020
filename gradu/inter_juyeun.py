...
video_file = "kapvi.mp4"  # 동영상 파일 경로   #동영상을 뽑아와야겠지
...
if cap.isOpened():  # 캡쳐 객체 초기화 확인
    ...
    while True:
        ...
        if ret:  # 프레임 읽기 정상일 경우
            ...
            if (st > 8.3 and fc == 0):  # 해당 psnr 값의 앞 뒤 차이가 1보다 크고 플래그가 0일경우에는
            ...
            if mouseflag ==1:
                break
            elif (st > 8.3 and fc == 1):  # st가 1보다 크지만, 이전에 바로 멈춘 상태여서 fc가 1일경우에는 그냥 패스하게 해준다
