...
void InitOpenGL()
{
	...
	// 텍스춰 좌표의 확장옵션
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT); // 옵션: GL_REPEAT, GL_CLAMP
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT); // 옵션: GL_REPEAT, GL_CLAMP

	// 확장/축소 필터
	glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);  // 옵션: GL_NEAREST, GL_LINEAR
	glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);  // 옵션: GL_NEAREST, GL_LINEAR
}
