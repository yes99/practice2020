...
// ii >>
// oo <<
void txttostring(string code[],int n)
{
    int i, j, k;
    string temp;
    string text;
...
void inputtext(string code[], int n)
{
    int i, j, k;
    string temp;
    string text;
...
int main()
{
    ...
    while (1)
    {
        ...
        if (textoption == 1)
        {
            txttostring(text, howmanytext);
            break;
        }
        else if(textoption == 2)
        {
            inputtext(text, howmanytext);
            break;
        }
        else
        {
    ...
    for (j = 0; j < 3; j++)
    {
        for (i = 0; i < lbadcode - lcode + 1; i++)
        {
            ...
            {
                cout << "virus found at " << j << "th text"<<endl;
                bmcnt++;
            }
        }
        if(bmcnt > 0)
